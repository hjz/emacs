...
(setq one-key-menu-ensime-alist
	...
	(("j" . "Ensime Import Type At Point (C-c C-r t)") . ensime-import-type-at-point)
	...
	(("k" . "Ensime Inspect Type At Point (C-c C-v i)") . ensime-inspect-type-at-point)
	(("o" . "Ensime Inspect Project Package (C-c C-v o)") . ensime-inspect-project-package)
	(("p" . "Ensime Inspect Package At Point (C-c C-v p)") . ensime-inspect-package-at-point)
	(("u" . "Ensime Show Uses Of Symbol At Point (C-c C-v r)") . ensime-show-uses-of-symbol-at-point)
	(("SPC" . "Ensime Sbt Switch (C-c C-v s)") . (lambda ()
                                                       (interactive)
                                                       (ensime-sbt-switch)
                                                       (other-window -1)
