...
(custom-set-faces
 ...
 '(ensime-errline ((((class color) (background dark)) (:underline "Firebrick4"))))
 '(ensime-errline-highlight ((t (:foreground "FireBrick3" :underline "FireBrick4"))))
