(custom-set-variables
 ...
 '(erc-modules (quote (autojoin button completion fill log match netsplit networks page replace ring services smiley stamp track autoaway move-to-prompt irccontrols spelling)))
